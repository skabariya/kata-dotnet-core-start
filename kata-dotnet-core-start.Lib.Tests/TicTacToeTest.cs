...
public class TicTacToeTest
{
    ...
    [Fact]
    public void Check_456_Winner_X()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(4); // X
    ...
    [Fact]
    public void Check_789_Winner_X()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(7); // X
    ...
    [Fact]
    public void Check_369_Winner_O()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(2); // X
    ...
    [Fact]
    public void Check_159_Winner_X()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(1); // X
    ...
    [Fact]
    public void Check_159_Winner_O()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(3); // X
    ...
    [Fact]
    public void Check_357_Winner_O()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(1); // X
    ...
    [Fact]
    public void Fill_all_board_then_game_over()
    {
        // Arrange
        var ticTacToe = new TickTacToe();
        ticTacToe.Enter(1); // X
